...
The `runners` dataframe above will likely include a lot of other data if "RUNNER_METADATA" is used, for horse racing this will include things like Weight carried, jockey, trainer, owner, etc.
