...
winner %>%
    ...
    ggplot(aes(x = collectedAt,
        ...
        theme_betfair()
```
<p style="text-align:right;"><sub><a href="https://raw.githubusercontent.com/durtal/betfaiR/gh-pages/vignette_three_files/figure-html/prem-outright-early-ko-1.png" target="_new">enlarge</a></sub></p>
</div>
</div>
