...
**2** | [`base_request`](base_request.html) | _filter_, _method_ | builds a basic request object | list with class that matches _method_ param
**3** | [`betfair_request`](betfair_request.html) | _x_, _..._ | fleshes out the request object | json object ready to be included in a POST request
