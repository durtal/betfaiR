...
`countries` | Retrieve data about the different countries hosting events | `TRUE` |
`events` | Retrieve data about the different events | `TRUE` |
`eventTypes` | Retrieve data about the different event types, ie. sports | `TRUE` |
...
`marketCatalogue` | Retrieve data about the different types of markets | `FALSE` |
`marketTypes` | Retrieve data about the different types of markets | `FALSE` |
`placeOrders` |  | `FALSE` |
