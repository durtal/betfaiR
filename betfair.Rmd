...
`marketBook` | Retrieve dynamic data about markets. Data includes prices, the status of the market, the status of the selections, the traded volume, and the status of any orders you have in the market | `TRUE` | _not available_
`marketCatalogue` | Retrieve data about the different types of markets | `FALSE` | [marketCatalogue](methods_marketCatalogue.html)
`marketTypes` | Retrieve counts for the different market types | `FALSE` | [marketTypes](methods_marketTypes.html)
