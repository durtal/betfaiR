...
This function allows bets to be updated with new instructions for what to do when the market goes in play.  Having logged in using the [`betfair`](betfair.html) function and placed any number of bets using the [`placeOrders`](placeOrders.html) function, you may wish to update some or all of those bets, the `updateOrders` method can help.
...
param | details
------|-------------------------------------------------------------------------
`...` | specific details about the bets to update, use [`update_inst`](bf_helpers.html#update_inst) function to target individual bets via their id
