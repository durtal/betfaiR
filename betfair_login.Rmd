...
* `ssoid`
    - list which includes a session token, it is this list which is to be used as the header in future requests made to the Exchange API via the [`bf_post`](betfair_POST.html) function.
