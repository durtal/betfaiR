...
The `bf_login` function is used to login to Betfair and return a session token, which is required to retrieve data from the exchange API using the different **methods**.
