theme_betfair <- function(base_size = 10, base_family = "", ...) {
    ...
    ggplot2::theme(
        ...
        text =                  ggplot2::element_text(family = base_family, face = "plain", colour = "#000000",
                                                      ...
                                                      lineheight = 0.9),
        axis.text =             ggplot2::element_text(size = ggplot2::rel(0.9), colour = "#000000"),
        strip.text =            ggplot2::element_text(size = ggplot2::rel(0.9)),
        axis.line =             ggplot2::element_blank(),
        axis.text.x =           ggplot2::element_text(vjust = 1, size = ggplot2::rel(0.8)),
        axis.text.y =           ggplot2::element_text(hjust = 1, size = ggplot2::rel(0.8)),
        axis.ticks =            ggplot2::element_blank(),
        axis.title.x =          ggplot2::element_text(size = ggplot2::rel(0.9)),
        axis.title.y =          ggplot2::element_text(size = ggplot2::rel(0.9), angle = 90),
