...
`orderBy` | how to order response, default orders by when they were placed, see [orderBy](betting_enums.html#orderby) for more details.
`sort` | how to sort results, see [sortDir](betting_enums.html#sortdir) for more details and options.
