...
```bash
schtasks /create /sc minute /sd 14/02/2016 /st 10:00 /ed 14/02/2016 /et 19:00 /tn betfairsupersunday /tr C:\Users\TomHeslop\Documents\Github\betfaiR\vignette_two\task.bat \k
```
...
6. `/k` informs the task scheduler to delete the task on completion.
